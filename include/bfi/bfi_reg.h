...
#define CT2_HOSTFN_EROMBAR_MSK		(CT2_PCI_APP_BASE + 0x48)
#define __PF_EROMBAR_MASK__MK		0xfffff800
#define __PF_EROMBAR_MASK__SH		11
#define __PF_EROMBAR_MASK_(_v)		((_v) << __PF_EROMBAR_MASK__SH)
...
#define	__FW_CONTROL_SPARES_MK		0xfff00000
#define __FW_CONTROL_SPARES_SH		20
#define __FW_CONTROL_SPARES(_v)	  ((_v) << __FW_CONTROL_SPARES_SH)
#define __FW_CONTROL_SPARES_HW_USE_MK    0x000c0000
#define __FW_CONTROL_SPARES_HW_USE_SH    18
#define __FW_CONTROL_SPARES_HW_USE(_v)   ((_v) << __FW_CONTROL_SPARES_HW_USE_SH)
#define __SIMULATE_REBOOT		0x00020000
#define __RESET_AND_START_SCLK_LCLK_PLLS 0x00010000
#define __FLASH_UPDATE_ENABLE_DELAY_INSTR_VALUES_MK 0x0000c000
#define __FLASH_UPDATE_ENABLE_DELAY_INSTR_VALUES_SH 14
#define __FLASH_UPDATE_ENABLE_DELAY_INSTR_VALUES(_v) \
		 ((_v) << __FLASH_UPDATE_ENABLE_DELAY_INSTR_VALUES_SH)
#define __FLASH_UPDATE_ENABLE_DELAY_INSTR 0x00002000
#define __FLASH_UPDATE_PENDING		0x00001000
#define __FLASH_UPDATE_PAUSE_NFC	0x00000800
#define __FW_CONTROL_SPARES_OEM_USE	0x00000400
#define __NFC_D3_COLD_OPERATION_ENABLE	0x00000200
#define __NFC_PCIE_RESET_INDICATOR	0x00000100
#define __MAC_1G_PORT1_STATUS		0x00000080
#define __MAC_1G_PORT0_STATUS		0x00000040
#define __WRITE_DWORD			0x00000020
#define __VAUX_STATUS			0x00000010
#define __FIRMWARE_BYPASS_CSI		0x00000008
#define __FIRMWARE_BYPASS_EPP		0x00000004
#define __FIRMWARE_SHUTTING_DOWN	0x00000002
#define __FIRMWARE_ALIVE		0x00000001
#define CT2_CSI_FW_CTL_CLR_REG		0x00027084
